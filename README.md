...
![](./_image/2018-02-09-09-48-21.jpg)  
...
top:150px;       → 然后进行调整。
```
- 相对定位**不脱标**，真实位置是在老家，只不过影子出去了，可以到处飘。
![](./_image/2018-02-09-09-50-45.jpg)
- 相对定位用途
相对定位有坑，所以一般不用于做“压盖”效果。页面中，效果极小。就两个作用：
1. 微调元素
2. 做绝对定位的参考，子绝父相
- 相对定位的定位值
1. 可以用left、right来描述盒子右、左的移动；
2. 可以用top、bottom来描述盒子的下、上的移动。
右下:  
```css
position: relative;
top: 10px;
...
#### 绝对定位
绝对定位比相对定位更灵活。  
![](./_image/2018-02-09-09-59-43.jpg)
- 绝对定位**脱标**
...
```
- 参考点
绝对定位的参考点，如果用top描述，那么定位参考点就是**页面的左上角**，而不是浏览器的左上角：
![](./_image/2018-02-09-10-01-42.jpg)  
如果用bottom描述，那么就是**浏览器首屏窗口尺寸，对应的页面的左下角**  
![](./_image/2018-02-09-10-02-04.jpg)  
- 以盒子为参考点
一个绝对定位的元素，如果**父辈元素**中出现了也定位了的元素，那么将以父辈这个元素，为参考点。
![](./_image/2018-02-09-10-03-00.jpg)  
...
![](./_image/2018-02-09-10-06-54.jpg)  
- 绝对定位的盒子居中
...
- 固定定位脱标！
![](./_image/2018-02-09-10-08-37.jpg)
**IE6不兼容**
#### z-index
